// :CATEGORY:vehicle
// :NAME:Air Camper
// :AUTHOR: Ezekiel Bailly
// :KEYWORDS:
// :CREATED:2014-04-19 15:56:37
// :EDITED:2014-04-19
// :ID:1034
// :NUM:1610
// :REV:1
...
integer thrustMultiplier = 7; // Amount thrust increases per click.
...
default 
{
 ...
 llListen(0,"",llGetOwner(),"");
        ...
        llSetCameraEyeOffset(<-14, 0, 0.5>); // Position of camera, relative to parent. 
      ...
      vector motor;
        ...
        if (motor_changed)
        {
            ...
            if(level & (CONTROL_RIGHT|CONTROL_ROT_RIGHT) && (acon == TRUE))
            {
               ...
               if(speed > 18)  motor.x +=(turnrate);
           
            //  if(geardown == FALSE)  motor.x += 4;
                 //3
                 else if(speed <= 18) motor.z -= 2;
