...
// Rev 3.2 Sensor patches for consitency in removing the NPC
//*******************************************************************//
...
// menus
string mSensor="No Sensor";    // Sensor or "No Sensor"

list lAtButtons = ["Menu","-", "More",         "@run","@walk","@fly",          "@land","@wander","@sit",  "@stand","@animate","@rotate"];
list lMenu2 = ["<<", "@comment", "@stop",      "@say","@whisper","@shout",     "@sound","@randsound", "@speed", "@cmd", "@pause", "@delete" ];
...
default
{
    ...
    no_sensor(){
        DEBUG ("no seat located, calling DoProcessNPCLine");
        DoProcessNPCLine();
    }
