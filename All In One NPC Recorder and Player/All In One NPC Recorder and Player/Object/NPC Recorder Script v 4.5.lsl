...
//////////////////////////////////////////////////////////
float     RANGE = 100;        // 1 to N meters  - anyone this close to the controller will start NPCS if Sensor button is clicked
integer   allowListener = FALSE; // set to TRUE to anable a command listener. Usually, this is setto FALSE
...
StateSpawn() {
   ...
   // llSay(0,llDumpList2String(name,",")); 
    ...
    llMessageLinked(LINK_SET,-1,"",aKey);    // bboradcast the key on num = -1
