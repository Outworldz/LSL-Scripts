...
// Diamond sparkly effect
// by Chandra Page
// 2004-12-06

// Based on Particle Script 0.5
...
// Particle paramaters
float age = 0.5;                  // Life of each particle
...
vector startSize = <.3,.05,.3>;     // Start size of particles 
vector endSize = <.3,.05,.3>;       // End size of particles (if interpSize == TRUE)
vector push = <0,0,0>;          // Force pushed on particles

// System paramaters
float rate = 5.0;            // How fast (rate) to emit particles
