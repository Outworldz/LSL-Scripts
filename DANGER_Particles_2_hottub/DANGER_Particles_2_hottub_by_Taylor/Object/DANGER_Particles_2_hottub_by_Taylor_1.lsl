// :CATEGORY:Particles
// :NAME:DANGER_Particles_2_hottub
// :AUTHOR:Taylor
...
// :WORLD:Second Life
// :DESCRIPTION:
// DANGER! Particles 2, hottub by Taylor.lsl
// :CODE:
...
float maxSpeed = 1.9;            // Max speed each particle is spit out at
...
vector startColor = <.7,.7,1>;    // Start color of particles <R,G,B>
vector endColor = <.9,.9,.9>;      // End color of particles <R,G,B> (if interpColor == TRUE)
vector startSize = <1,1,1>;     // Start size of particles 
vector endSize = <0.4,0.4,0.4>;       // End size of particles (if interpSize == TRUE)
...
float innerAngle = 0.55;    // Inner angle for all ANGLE patterns
