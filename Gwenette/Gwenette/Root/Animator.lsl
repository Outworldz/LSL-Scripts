...
//You can now animate any object, with just one script!Â  Setup is very simple. Just drop the script and a blank notecard into the object, click the object, and give your animation a name.Â  Move all the prims around, and click Record.Â When done, click the Animation Name, and watch it play back every move!
