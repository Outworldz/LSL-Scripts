...
// Listing 9.4: Rainbow -- Green, Blue, Indigo, and Violet
...
startRainbowGBIV()
{
    ...
    llParticleSystem( [
     ...
     //Appearance
        PSYS_PART_START_SCALE, <1.75, 0.3, 0.0>,    // <1,1,0>,
        PSYS_PART_END_SCALE,   <2.00, 0.3, 0.0>,    // <1,1,0>,
        PSYS_PART_START_COLOR, <1.0, 0.0, 1.0>,     // <1,1,1>,
        PSYS_PART_END_COLOR,   <0.0, 1.0, 0.0>,     // <1,1,1>,
    ...
    //Placement
        ...
        PSYS_SRC_BURST_RADIUS, 14.0,               // 0.00,
