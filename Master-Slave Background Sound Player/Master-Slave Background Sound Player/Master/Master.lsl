...
float timer_interval = 9.0;         // how long you sliced your wave files, must be less than 10. 9.0 is typical.
float set_text_alpha = 1;           //Set this to 0 to disable hovertext the text transparency fo alpha text.
integer play_at_master = TRUE;      // if TRUE, the master will play sounds, too.  Set to DLASE and the Master will only broadcast to slaves.
