// :SHOW:1
// :CATEGORY:Vehicle
// :NAME:Opensim BulletSim Supercar
...
//  Supercar has been tested for both ODE and Bulletsim and are both configured to go really fast. You just need to remember that if you do not have atleast a 2048×2048 varregion, you will have to refrain from using the the top 4 gears which was actually design for drag racing.
...
// Rev 1.1 04-14-2015 Vegaslon  changed llSetVehicleRotationParam to reset all axes <0,0,0>
