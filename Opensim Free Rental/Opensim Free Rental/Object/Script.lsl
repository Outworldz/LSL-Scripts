...
// :WORLD:Second Life
// :DESCRIPTION:
// No Money Rental (Vendor).lsl// User can touch the sign and claim a land for a set period.// You can force them to reclaim every so often, set a grace period, and enforce a number of prims.
// :CODE:
