// :CATEGORY:Particles
// :NAME:Purple_particles_Find_Owner
// :AUTHOR:Anonymous
...
// :WORLD:Second Life
// :DESCRIPTION:
// Purple particles Find Owner.lsl
// :CODE:
...
vector startColor = <0.7,0,0.8>;    // Start color of particles <R,G,B>
vector endColor = <0,0,0>;      // End color of particles <R,G,B> (if interpColor == TRUE)
vector startSize = <1,1,10>;     // Start size of particles 
vector endSize = <.1,.1,.1>;       // End size of particles (if interpSize == TRUE)
vector push = <0,0,0>;          // Force pushed on particles

// System paramaters
float rate = .0000000000000001;            // How fast (rate) to emit particles
