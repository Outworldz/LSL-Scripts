...
default
{
    ...
    link_message(integer sender_num, integer num, string str, key id)
    {
        if (num==6000) {
            ...
            //llSay(0,(string)id + "@lsl.secondlife.com");
            //llSay(0,llGetSubString(subject,0,-1));
            //llSay(0,llGetSubString(message,1,-1));
