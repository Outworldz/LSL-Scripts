// :CATEGORY:Blink
// :NAME:Small_Golden_disk_bling
// :AUTHOR:Stormy Roentgren
...
string  texture             = "203bd8cf-7531-287a-ef8f-2ff847455778";                 // Texture used for particles, default used if blank
float startAlpha = 1;           // Start alpha (transparency) value
float endAlpha = 1;           // End alpha (transparency) value
vector startColor = <1,1,1>;    // Start color of particles <R,G,B>
vector endColor = <1,1,1>;      // End color of particles <R,G,B> (if interpColor == TRUE)
vector startSize = <.04,.1,.02>;     // Start size of particles 
vector endSize = <.01,.1,.04>;       // End size of particles (if interpSize == TRUE)
...
vector omega = <0,0,0.01>;    // Rotation of ANGLE patterns around the source
