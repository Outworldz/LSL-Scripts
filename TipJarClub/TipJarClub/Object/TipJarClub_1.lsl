...
// Notecard Format:
// Name of notecard must be Config
// Line one - Pay price, comma delimited
// Line 2: Percent to pay to tip claimer
// Line 3: timeout, in seconds
// Line 4: 'group' if you want groups enabled, so that only members of the group can claim the jar,
